...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{glp1.png}
...
Figure \ref{fig-glp1} shows the initial and final stable state of the GLP-1 and Figure \ref{fig:RMSD_RMSF} shows the RMSD and RMSF of this equilibrium showing an excellent stable conformation. 
...
During the RMSD and RMSF analysis, shown in Figure \ref{fig:RMSD_RMSF} it was observed that L28 destabilized the protein the most between ns and  ns. 
\vspace{-1.0cm}
\begin{figure}[htbp]
\centering 
...
This study was conducted under the surveillance of Professor Badhin, in the
computational laboratory of the Catholic University of Santa Maria. We would like
to thank Professor Badhin for the hospitality and kindness, allowing the realiza-
